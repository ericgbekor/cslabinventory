...
<!--            </li>-->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link"  data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false" data-target="sidenavbarDropdownMenuLink">
                    <i class="material-icons">person</i>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="sidenavbarDropdownMenuLink">
...
<!--            </form>-->
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <button class="btn btn-primary btn-round btn-just-icon"  data-toggle="dropdown" aria-haspopup="true"
...
<!--                </div>-->
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover stripe " id="itemtable">
                      <thead>
                      <tr>
  ...
  <script>
      $(document).ready(function () {
          $.ajax({
              type: "GET",
              async:true,
              url: "../controllers/request_ajax.php?cmd=8",
              data: {},
              cache: false,
...
//                          {"data" : "request_status"},
                          {"data" : "checked_out_by"},
                          {"data" : "checked_out_at", "width" : "15%"},
                          {"data" : "returned_by", "width" : "15%"},
                          {"data" : "returned_at", "width" : "15%"},
                          {"data" : "item_code", "width" : "10%"},
                          {"data" : "comments", "width" : "15%"},
                          {
                              "defaultContent": "<button class='btn-primary' onclick='checkOut(this)'>Check Out</button>", "width" : "15%"
                          },
                          {
                              "defaultContent": "<button class='btn-success' onclick='checkIn(this)'>Check In</button>", "width" : "15%"
                          },
                          {
                              "defaultContent": "<button class='btn-secondary' onclick='addComment(this)'><i class='material-icons'>comment</i></button>"
                          }
...
//          var current_row_id = current_object.parentNode.parentNode.rowIndex;
          ...
          $('#request').val(current_item_id).prop("disabled",true);
...
//          var current_row_id = current_object.parentNode.parentNode.rowIndex;
          ...
          $('#request_id').val(current_item_id).prop("disabled",true);
      ...
      function checkOutComplete(){
          ...
          console.log(itemcode, received, request_id);
          $.ajax({
              type: "GET",
              async:true,
